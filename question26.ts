...
if (alienColor === 'green') {
    console.log('congragulation! you just earned 5 points for shooting down the green alien.');
} else {
...
if (alienColor === 'yellow') {
    console.log('congragulation! you just earned 5 points for shooting down the yellow alien');
} else {
    console.log('you just earned 10 points for shooting an alien of a different color.');
} 
